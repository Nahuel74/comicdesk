...
class ReadingListHeader(QWidget):
    ...
    def __init__(self, reading_list, parent=None):
        ...
        self.add_issue_btn.clicked.connect(self.add_issue_requested)
        ...
        row2.addWidget(self.add_issue_btn)
    ...
    def resizeEvent(self, event):
        ...
        if compact:
            ...
            self.add_issue_btn.hide()
            self.export_btn.hide()
            self.clear_btn.hide()
            menu.addAction("Import CBL", self.import_btn.click)
            menu.addAction("Add issue", self.add_issue_btn.click)
    ...
    def apply_theme(self, theme: str) -> None:
        ...
        self.add_issue_btn.setStyleSheet(default_btn)
